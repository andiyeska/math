...
@Service
public class GetEquationQuadraticNonUseCase implements GetEquationQuadraticNonInputBoundary {

    @Override
    public GetEquationQuadraticNonResponse getSolution(GetEquationQuadraticNonRequest request) throws Exception {
        ...
        return new GetEquationQuadraticNonResponse(solution);
    }
    ...
    private void doOperation(Solution solution, Operator operator, List<Term> rightTerms, String description) {
        ...
        step.setLeftEquationAfter(step.getLeftOperationAfter());
        step.setRightOperationAfter(Term.printTerms(solution.getRightTerms()));
        step.setRightEquationAfter(step.getRightOperationAfter());
