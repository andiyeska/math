...
import com.example.math.service.equation.qudratic.non.GetEquationQuadraticNonUseCase;
import org.junit.jupiter.api.Assertions;
import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

public class GetEquationQuadraticNonUseCaseTest {

    GetEquationQuadraticNonUseCase useCase;
    GetEquationQuadraticNonRequest request;

    @BeforeEach
    void init() {
        useCase = new GetEquationQuadraticNonUseCase();
        request = new GetEquationQuadraticNonRequest();
    }
